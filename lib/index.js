...
function deliver(namespace) {
    var Target = function (Clazz) {
        return function () {
                            ...
                            var runGen_1 = function (ge, val) {
                                ...
                                if (tmp.value && tmp.value.then) {
                                    return tmp.value.then(function (data) {
                                        return runGen_1(ge, data);
                                    }).catch(function (e) { return ge.throw(e); });
                                }
                                return runGen_1(ge, tmp.value);
                            };
                            return Promise.resolve().then(function () { return runGen_1(origin_1.bind(_this).apply(void 0, params), null); });
                        }
                        var state = _store.getState()[ns];
                        var _state = {};
                        Object.keys(state).forEach(function (_key) {
            ...
            prototype.connect = function (selector) {
